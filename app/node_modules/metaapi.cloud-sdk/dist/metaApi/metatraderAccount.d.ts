import { ConfigurationLink, MetatraderAccountDto, MetatraderAccountIdDto, MetatraderAccountUpdateDto, NewMetaTraderAccountReplicaDto } from "metaapi.cloud-sdk/dist/clients/metaApi/metatraderAccount.client";
import MetaApiWebsocketClient, { MetatraderCandle, MetatraderTick } from "metaapi.cloud-sdk/dist/clients/metaApi/metaApiWebsocket.client";
import ConnectionRegistry from "metaapi.cloud-sdk/dist/metaApi/connectionRegistry";
import ExpertAdvisorClient, { NewExpertAdvisorDto } from "metaapi.cloud-sdk/dist/clients/metaApi/expertAdvisor.client";
import HistoricalMarketDataClient from "metaapi.cloud-sdk/dist/clients/metaApi/historicalMarketData.client";
import HistoryStorage from "metaapi.cloud-sdk/dist/metaApi/historyStorage";
import RpcMetaApiConnectionInstance from "metaapi.cloud-sdk/dist/metaApi/rpcMetaApiConnectionInstance";
import ExpertAdvisor from "metaapi.cloud-sdk/dist/metaApi/expertAdvisor";
import StreamingMetaApiConnectionInstance from "metaapi.cloud-sdk/dist/metaApi/streamingMetaApiConnectionInstance";
import MetatraderAccountReplica from 'metaapi.cloud-sdk/dist/metaApi/metatraderAccountReplica';
import MetatraderAccountClient, {Reliability, State, Version, ConnectionStatus, CopyFactoryRoles, Type, AccountConnection} from 'metaapi.cloud-sdk/dist/clients/metaApi/metatraderAccount.client'
